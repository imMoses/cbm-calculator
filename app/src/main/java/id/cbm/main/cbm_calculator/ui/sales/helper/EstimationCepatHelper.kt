...
class EstimationCepatHelper(private val context: Context) {
    ...
    private fun typeAtapList(): MutableList<GeneralModel> {
    ...
    private fun jenisPenutupAtap(): MutableList<GeneralModel> {
        val list = mutableListOf(
            GeneralModel(
                id = "102",
